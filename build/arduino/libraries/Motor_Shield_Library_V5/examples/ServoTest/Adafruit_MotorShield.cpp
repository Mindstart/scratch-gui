...
Adafruit_Servo *Adafruit_MotorShield::getServo(uint8_t num) {
...
Adafruit_Servo::Adafruit_Servo(void) {
  MC = NULL;
  servonum = 0;
  PWMpin = 0;
  currentAngle = 0;
...
void Adafruit_Servo::setServoPulse(double pulse) {
  double pulselength;
...
void Adafruit_Servo::writeServo(uint8_t angle) {
  double pulse;
...
uint8_t Adafruit_Servo::readDegrees() {
  return currentAngle;
}
